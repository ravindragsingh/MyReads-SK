...
class SearchBooks extends Component {
    ...
    render() {
        ...
        return ( <
            ...
            onClick = { this.props.closeSearch } > Close < /a> <
            div className = "search-books-input-wrapper" >
            <
            input type = "text"
            placeholder = "Search by title or author"
            onChange = {
                (event) => this.searchBooks(event.target.value)
            }
            /> < /
            div > <
            /div> <
            div className = "search-books-results" > { console.log("searchBooks", this.state.books) } { /*<ol className="books-grid"></ol>*/ } <
